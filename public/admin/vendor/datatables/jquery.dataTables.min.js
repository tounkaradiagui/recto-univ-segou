...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Précédent"},sEmptyTable:"Aucune donnée disponible dans la table",sInfo:"Montre _START_ sur _END_ des _TOTAL_ entrées",sInfoEmpty:"Montre 0 to 0 of 0 entrer",
sInfoFiltered:"(filtered from _MAX_ total entrées)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Voir _MENU_ entrées",sLoadingRecords:"Chargement...",sProcessing:"En cours...",sSearch:"Rechercher:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun n'enregistrement trouvé"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
