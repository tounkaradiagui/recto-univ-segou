...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Valider un dossier étudiant</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Formulaire de validation</h6>
        </div>
            ...
            <div class="card">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-3 mb-3 mt-3 mb-sm-0">
                            ...
                            value="{{ old('numero_de_place') ? old('numero_de_place') : $validate->numero_de_place }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            <input 
                                ...
                                value="{{ old('lieu_de_naissance') ? old('lieu_de_naissance') : $validate->lieu_de_naissance }}">
                        ...
                        <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                            ...
                            name="nom_pere" 
                            value="{{ old('nom_pere') ? old('nom_pere') : $validate->nom_pere }}">
                        ...
                        <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                            ...
                            name="prenom_pere" 
                            value="{{ old('prenom_pere') ? old('prenom_pere') : $validate->prenom_pere }}">
                        ...
                        <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                            ...
                            value="{{ old('profession_pere') ? old('profession_pere') : $validate->profession_pere }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            name="residence_pere" 
                            value="{{ old('residence_pere') ? old('residence_pere') : $validate->residence_pere }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            name="telephone_pere" 
                            value="{{ old('telephone_pere') ? old('telephone_pere') : $validate->telephone_pere }}">
                        ...
                        <div class="col-sm-4 mb-3 mt-5 mb-sm-0">
                            ...
                            name="nom_mere" 
                            value="{{ old('nom_mere') ? old('nom_mere') : $validate->nom_mere }}">
                        ...
                        <div class="col-sm-4 mb-3 mt-3 mt-5 mb-sm-0">
                            ...
                            name="prenom_mere" 
                            value="{{ old('prenom_mere') ? old('prenom_mere') : $validate->prenom_mere }}">
                        ...
                        <div class="col-sm-4 mb-3 mt-3 mt-5 mb-sm-0">
                            ...
                            value="{{ old('profession_mere') ? old('profession_mere') : $validate->profession_mere }}">
                        ...
                        <div class="col-sm-6 mb-3 mt-3 mb-sm-0">
                            ...
                            placeholder="Région, Ville ou Quartier" 
                            name="residence_mere" 
                            value="{{ old('residence_mere') ? old('residence_mere') : $validate->residence_mere }}">
                        ...
                        <div class="col-sm-4 mb-3 mt-3 mb-sm-0">
                            ...
                            placeholder="Saisir le numéro du parent" 
                            name="telephone_mere" 
                            value="{{ old('telephone_mere') ? old('telephone_mere') : $validate->telephone_mere }}">
